...
import { CfnServerlessPrivateEndpoint,CfnServerlessPrivateEndpointProps,AwsPrivateEndpointConfig } from "../../../src/l1-resources/serverless-private-endpoint";
...
test("CfnCloudOutageSimulation construct should contain default properties", () => {
  ...
  new CfnServerlessPrivateEndpoint(stack, "testing-serverlessPrivateEndpointWithAws", {
