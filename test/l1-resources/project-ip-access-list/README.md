...
- Follow prerequisite steps for the corresponding [Project Access List CFN resource](https://github.com/mongodb/mongodbatlas-cloudformation-resources/blob/master/cfn-resources/project-ip-access-list/test/README.md).
