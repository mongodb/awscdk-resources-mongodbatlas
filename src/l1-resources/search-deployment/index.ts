...
export function toJson_CfnSearchDeploymentProps(obj: CfnSearchDeploymentProps | undefined): Record<string, any> | undefined {
 ...
 */
/* eslint-disable max-len, quote-props */
export function toJson_ApiSearchDeploymentSpec(obj: ApiSearchDeploymentSpec | undefined): Record<string, any> | undefined {
  if (obj === undefined) { return undefined; }
  const result = {
...
export class CfnSearchDeployment extends cdk.CfnResource {
  ...
  */
  public static readonly CFN_RESOURCE_TYPE_NAME = "MongoDB::Atlas::SearchDeployment";
  ...
  constructor(scope: constructs.Construct, id: string, props: CfnSearchDeploymentProps) {
    super(scope, id, { type: CfnSearchDeployment.CFN_RESOURCE_TYPE_NAME, properties: toJson_CfnSearchDeploymentProps(props)! });

    this.props = props;

    this.attrId = cdk.Token.asString(this.getAtt('Id'));
    this.attrStateName = cdk.Token.asString(this.getAtt('StateName'));
    this.attrEncryptionAtRestProvider = cdk.Token.asString(this.getAtt('EncryptionAtRestProvider'));
  }
}