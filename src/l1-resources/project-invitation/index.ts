...
export function toJson_CfnProjectInvitationProps(
  obj: CfnProjectInvitationProps | undefined
...
export class CfnProjectInvitation extends cdk.CfnResource {
  ...
  constructor(
    ...
    super(scope, id, {
      type: CfnProjectInvitation.CFN_RESOURCE_TYPE_NAME,
      properties: toJson_CfnProjectInvitationProps(props)!,
    });
