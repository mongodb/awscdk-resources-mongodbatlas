...
export function toJson_CfnStreamWorkspaceProps(
  obj: CfnStreamWorkspaceProps | undefined
...
export class CfnStreamWorkspace extends cdk.CfnResource {
  ...
  constructor(
    ...
    super(scope, id, {
      type: CfnStreamWorkspace.CFN_RESOURCE_TYPE_NAME,
      properties: toJson_CfnStreamWorkspaceProps(props)!,
    });
