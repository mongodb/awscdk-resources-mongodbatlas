...
export function toJson_CfnCloudBackUpRestoreJobsProps(obj: CfnCloudBackUpRestoreJobsProps | undefined): Record<string, any> | undefined {
  ...
  const result = {
    ...
    'SynchronousCreationOptions': toJson_SynchronousCreationOptions(obj.synchronousCreationOptions),
  };
 ...
 */
/* eslint-disable max-len, quote-props */
export function toJson_SynchronousCreationOptions(obj: SynchronousCreationOptions | undefined): Record<string, any> | undefined {
  if (obj === undefined) { return undefined; }
  const result = {
