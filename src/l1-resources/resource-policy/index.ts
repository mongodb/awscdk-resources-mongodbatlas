...
export function toJson_CfnResourcePolicyProps(obj: CfnResourcePolicyProps | undefined): Record<string, any> | undefined {
 ...
 */
/* eslint-disable max-len, quote-props */
export function toJson_ApiAtlasUserMetadata(obj: ApiAtlasUserMetadata | undefined): Record<string, any> | undefined {
  if (obj === undefined) { return undefined; }
  const result = {
    'Id': obj.id,
    'Name': obj.name,
 ...
 */
/* eslint-disable max-len, quote-props */
export function toJson_ApiAtlasPolicy(obj: ApiAtlasPolicy | undefined): Record<string, any> | undefined {
  if (obj === undefined) { return undefined; }
  const result = {
    'Body': obj.body,
    'Id': obj.id,
...
export class CfnResourcePolicy extends cdk.CfnResource {
  ...
  */
  public static readonly CFN_RESOURCE_TYPE_NAME = "MongoDB::Atlas::ResourcePolicy";
  ...
  constructor(scope: constructs.Construct, id: string, props: CfnResourcePolicyProps) {
    super(scope, id, { type: CfnResourcePolicy.CFN_RESOURCE_TYPE_NAME, properties: toJson_CfnResourcePolicyProps(props)! });
