...
export function toJson_CfnFlexClusterProps(obj: CfnFlexClusterProps | undefined): Record<string, any> | undefined {
 ...
 */
/* eslint-disable max-len, quote-props */
export function toJson_ProviderSettings(obj: ProviderSettings | undefined): Record<string, any> | undefined {
  if (obj === undefined) { return undefined; }
  const result = {
 ...
 */
/* eslint-disable max-len, quote-props */
export function toJson_BackupSettings(obj: BackupSettings | undefined): Record<string, any> | undefined {
  if (obj === undefined) { return undefined; }
  const result = {
    'Enabled': obj.enabled,
  };
...
export class CfnFlexCluster extends cdk.CfnResource {
  ...
  */
  ...
  constructor(scope: constructs.Construct, id: string, props: CfnFlexClusterProps) {
    super(scope, id, { type: CfnFlexCluster.CFN_RESOURCE_TYPE_NAME, properties: toJson_CfnFlexClusterProps(props)! });
    ...
    this.attrVersionReleaseSystem = cdk.Token.asString(this.getAtt('VersionReleaseSystem'));
  }
}