...
export function toJson_CfnCloudBackupSnapshotProps(
  obj: CfnCloudBackupSnapshotProps | undefined
  ...
  const result = {
    ...
    Results: obj.results?.map((y) =>
      toJson_ApiAtlasDiskBackupShardedClusterSnapshotView(y)
    ),
 ...
 */
/* eslint-disable max-len, quote-props */
export function toJson_ApiAtlasDiskBackupShardedClusterSnapshotMemberView(
  obj: ApiAtlasDiskBackupShardedClusterSnapshotMemberView | undefined
): Record<string, any> | undefined {
  if (obj === undefined) {
    return undefined;
  }
 ...
 */
/* eslint-disable max-len, quote-props */
export function toJson_ApiAtlasDiskBackupShardedClusterSnapshotView(
  obj: ApiAtlasDiskBackupShardedClusterSnapshotView | undefined
): Record<string, any> | undefined {
  if (obj === undefined) {
    return undefined;
  }
...
export class CfnCloudBackupSnapshot extends cdk.CfnResource {
  ...
  constructor(
    ...
    this.attrStorageSizeBytes = cdk.Token.asString(
      this.getAtt("StorageSizeBytes")
    );
