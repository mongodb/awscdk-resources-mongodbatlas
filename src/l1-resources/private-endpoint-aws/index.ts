...
export function toJson_CfnPrivateEndpointAwsProps(obj: CfnPrivateEndpointAwsProps | undefined): Record<string, any> | undefined {
...
export class CfnPrivateEndpointAws extends cdk.CfnResource {
  ...
  */
  public static readonly CFN_RESOURCE_TYPE_NAME = "MongoDB::Atlas::PrivateEndpointAWS";
   ...
   */
  constructor(scope: constructs.Construct, id: string, props: CfnPrivateEndpointAwsProps) {
    super(scope, id, { type: CfnPrivateEndpointAws.CFN_RESOURCE_TYPE_NAME, properties: toJson_CfnPrivateEndpointAwsProps(props)! });
