...
export function toJson_CfnAccessListApiKeyProps(obj: CfnAccessListApiKeyProps | undefined): Record<string, any> | undefined {
...
export class CfnAccessListApiKey extends cdk.CfnResource {
  ...
  */
  public static readonly CFN_RESOURCE_TYPE_NAME = "MongoDB::Atlas::AccessListAPIKey";
   ...
   */
  constructor(scope: constructs.Construct, id: string, props: CfnAccessListApiKeyProps) {
    super(scope, id, { type: CfnAccessListApiKey.CFN_RESOURCE_TYPE_NAME, properties: toJson_CfnAccessListApiKeyProps(props)! });
