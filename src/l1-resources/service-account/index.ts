 ...
 */
/* eslint-disable max-len, quote-props */
export function toJson_Secret(obj: Secret | undefined): Record<string, any> | undefined {
  if (obj === undefined) { return undefined; }
  const result = {
    'Id': obj.id,
...
export class CfnServiceAccount extends cdk.CfnResource {
  ...
  */
  public static readonly CFN_RESOURCE_TYPE_NAME = "MongoDB::Atlas::ServiceAccount";
