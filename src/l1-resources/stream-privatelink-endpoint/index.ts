...
export function toJson_CfnStreamPrivatelinkEndpointProps(
  obj: CfnStreamPrivatelinkEndpointProps | undefined
...
export class CfnStreamPrivatelinkEndpoint extends cdk.CfnResource {
  ...
  constructor(
    ...
    super(scope, id, {
      type: CfnStreamPrivatelinkEndpoint.CFN_RESOURCE_TYPE_NAME,
      properties: toJson_CfnStreamPrivatelinkEndpointProps(props)!,
    });
    ...
    this.attrInterfaceEndpointName = cdk.Token.asString(
      this.getAtt("InterfaceEndpointName")
    );
    this.attrProviderAccountId = cdk.Token.asString(
      this.getAtt("ProviderAccountId")
    );
