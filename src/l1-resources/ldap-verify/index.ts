...
export function toJson_CfnLdapVerifyProps(
  obj: CfnLdapVerifyProps | undefined
 ...
 */
/* eslint-disable max-len, quote-props */
export function toJson_Validation(
...
export class CfnLdapVerify extends cdk.CfnResource {
  ...
  constructor(
    ...
    super(scope, id, {
      type: CfnLdapVerify.CFN_RESOURCE_TYPE_NAME,
      properties: toJson_CfnLdapVerifyProps(props)!,
    });
