 ...
 */
/* eslint-disable max-len, quote-props */
export function toJson_TypeSet(obj: TypeSet | undefined): Record<string, any> | undefined {
  if (obj === undefined) { return undefined; }
  const result = {
    'Name': obj.name,
    'Types': obj.types,
 ...
 */
/* eslint-disable max-len, quote-props */
export function toJson_ApiAtlasFtsAnalyzersTokenizer(obj: ApiAtlasFtsAnalyzersTokenizer | undefined): Record<string, any> | undefined {
  if (obj === undefined) { return undefined; }
  const result = {
    'MaxGram': obj.maxGram,
    'MinGram': obj.minGram,
