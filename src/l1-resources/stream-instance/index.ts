...
export function toJson_CfnStreamInstanceProps(obj: CfnStreamInstanceProps | undefined): Record<string, any> | undefined {
 ...
 */
/* eslint-disable max-len, quote-props */
export function toJson_StreamsConnection(obj: StreamsConnection | undefined): Record<string, any> | undefined {
  if (obj === undefined) { return undefined; }
  const result = {
    'Name': obj.name,
    'Type': obj.type,
...
export class CfnStreamInstance extends cdk.CfnResource {
  ...
  */
  public static readonly CFN_RESOURCE_TYPE_NAME = "MongoDB::Atlas::StreamInstance";
  ...
  constructor(scope: constructs.Construct, id: string, props: CfnStreamInstanceProps) {
    super(scope, id, { type: CfnStreamInstance.CFN_RESOURCE_TYPE_NAME, properties: toJson_CfnStreamInstanceProps(props)! });
