...
export function toJson_CfnServiceAccountProjectAssignmentProps(
  obj: CfnServiceAccountProjectAssignmentProps | undefined
...
export class CfnServiceAccountProjectAssignment extends cdk.CfnResource {
  ...
  constructor(
    ...
    super(scope, id, {
      type: CfnServiceAccountProjectAssignment.CFN_RESOURCE_TYPE_NAME,
      properties: toJson_CfnServiceAccountProjectAssignmentProps(props)!,
    });
