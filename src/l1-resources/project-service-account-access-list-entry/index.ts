...
export function toJson_CfnProjectServiceAccountAccessListEntryProps(
  obj: CfnProjectServiceAccountAccessListEntryProps | undefined
...
export class CfnProjectServiceAccountAccessListEntry extends cdk.CfnResource {
  ...
  constructor(
    ...
    super(scope, id, {
      type: CfnProjectServiceAccountAccessListEntry.CFN_RESOURCE_TYPE_NAME,
      properties: toJson_CfnProjectServiceAccountAccessListEntryProps(props)!,
    });
