...
export function toJson_CfnNetworkPeeringProps(
  obj: CfnNetworkPeeringProps | undefined
...
export class CfnNetworkPeering extends cdk.CfnResource {
  ...
  constructor(
    ...
    super(scope, id, {
      type: CfnNetworkPeering.CFN_RESOURCE_TYPE_NAME,
      properties: toJson_CfnNetworkPeeringProps(props)!,
    });
