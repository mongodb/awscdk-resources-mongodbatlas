...
export function toJson_CfnOrganizationProps(obj: CfnOrganizationProps | undefined): Record<string, any> | undefined {
...
export class CfnOrganization extends cdk.CfnResource {
  ...
  */
  public static readonly CFN_RESOURCE_TYPE_NAME = "MongoDB::Atlas::Organization";
  ...
  constructor(scope: constructs.Construct, id: string, props: CfnOrganizationProps) {
    super(scope, id, { type: CfnOrganization.CFN_RESOURCE_TYPE_NAME, properties: toJson_CfnOrganizationProps(props)! });
