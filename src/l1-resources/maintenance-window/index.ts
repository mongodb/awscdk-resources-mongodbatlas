...
export function toJson_CfnMaintenanceWindowProps(obj: CfnMaintenanceWindowProps | undefined): Record<string, any> | undefined {
  ...
  const result = {
    ...
    'ProtectedHours': toJson_CfnMaintenanceWindowPropsProtectedHours(obj.protectedHours),
  };
 ...
 */
/* eslint-disable max-len, quote-props */
export function toJson_CfnMaintenanceWindowPropsProtectedHours(obj: CfnMaintenanceWindowPropsProtectedHours | undefined): Record<string, any> | undefined {
  if (obj === undefined) { return undefined; }
  const result = {
...
export class CfnMaintenanceWindow extends cdk.CfnResource {
  ...
  */
  ...
  constructor(scope: constructs.Construct, id: string, props: CfnMaintenanceWindowProps) {
    ...
    this.attrNumberOfDeferrals = cdk.Token.asNumber(this.getAtt('NumberOfDeferrals'));
