...
export function toJson_CfnLogIntegrationProps(obj: CfnLogIntegrationProps | undefined): Record<string, any> | undefined {
...
export class CfnLogIntegration extends cdk.CfnResource {
  ...
  */
  public static readonly CFN_RESOURCE_TYPE_NAME = "MongoDB::Atlas::LogIntegration";
   ...
   */
  constructor(scope: constructs.Construct, id: string, props: CfnLogIntegrationProps) {
    super(scope, id, { type: CfnLogIntegration.CFN_RESOURCE_TYPE_NAME, properties: toJson_CfnLogIntegrationProps(props)! });
