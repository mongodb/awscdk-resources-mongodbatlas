...
export function toJson_CfnProjectServiceAccountProps(obj: CfnProjectServiceAccountProps | undefined): Record<string, any> | undefined {
 ...
 */
/* eslint-disable max-len, quote-props */
export function toJson_SecretDefinition(obj: SecretDefinition | undefined): Record<string, any> | undefined {
  if (obj === undefined) { return undefined; }
  const result = {
    'Id': obj.id,
...
export class CfnProjectServiceAccount extends cdk.CfnResource {
  ...
  */
  public static readonly CFN_RESOURCE_TYPE_NAME = "MongoDB::Atlas::ProjectServiceAccount";
  ...
  constructor(scope: constructs.Construct, id: string, props: CfnProjectServiceAccountProps) {
    super(scope, id, { type: CfnProjectServiceAccount.CFN_RESOURCE_TYPE_NAME, properties: toJson_CfnProjectServiceAccountProps(props)! });
