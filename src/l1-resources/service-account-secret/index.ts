...
export function toJson_CfnServiceAccountSecretProps(
  obj: CfnServiceAccountSecretProps | undefined
...
export class CfnServiceAccountSecret extends cdk.CfnResource {
  ...
  constructor(
    ...
    super(scope, id, {
      type: CfnServiceAccountSecret.CFN_RESOURCE_TYPE_NAME,
      properties: toJson_CfnServiceAccountSecretProps(props)!,
    });
