...
export function toJson_CfnAuditingProps(
  obj: CfnAuditingProps | undefined
...
export class CfnAuditing extends cdk.CfnResource {
  ...
  constructor(
    ...
    super(scope, id, {
      type: CfnAuditing.CFN_RESOURCE_TYPE_NAME,
      properties: toJson_CfnAuditingProps(props)!,
    });

    this.props = props;

    this.attrAuditFilter = cdk.Token.asString(this.getAtt("AuditFilter"));
    this.attrConfigurationType = cdk.Token.asString(
      this.getAtt("ConfigurationType")
    );
    this.attrAuditAuthorizationSuccess = this.getAtt(
