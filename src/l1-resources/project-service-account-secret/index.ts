...
export function toJson_CfnProjectServiceAccountSecretProps(obj: CfnProjectServiceAccountSecretProps | undefined): Record<string, any> | undefined {
...
export class CfnProjectServiceAccountSecret extends cdk.CfnResource {
  ...
  */
  public static readonly CFN_RESOURCE_TYPE_NAME = "MongoDB::Atlas::ProjectServiceAccountSecret";
  ...
  constructor(scope: constructs.Construct, id: string, props: CfnProjectServiceAccountSecretProps) {
    super(scope, id, { type: CfnProjectServiceAccountSecret.CFN_RESOURCE_TYPE_NAME, properties: toJson_CfnProjectServiceAccountSecretProps(props)! });
