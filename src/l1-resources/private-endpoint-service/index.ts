...
export function toJson_CfnPrivateEndpointServiceProps(obj: CfnPrivateEndpointServiceProps | undefined): Record<string, any> | undefined {
...
export class CfnPrivateEndpointService extends cdk.CfnResource {
  ...
  */
  public static readonly CFN_RESOURCE_TYPE_NAME = "MongoDB::Atlas::PrivateEndpointService";
   ...
   */
  constructor(scope: constructs.Construct, id: string, props: CfnPrivateEndpointServiceProps) {
    super(scope, id, { type: CfnPrivateEndpointService.CFN_RESOURCE_TYPE_NAME, properties: toJson_CfnPrivateEndpointServiceProps(props)! });

    this.props = props;

    this.attrId = cdk.Token.asString(this.getAtt('Id'));
    this.attrEndpointServiceName = cdk.Token.asString(this.getAtt('EndpointServiceName'));
