...
export function toJson_CfnCustomDbRoleProps(
  obj: CfnCustomDbRoleProps | undefined
 ...
 */
/* eslint-disable max-len, quote-props */
export function toJson_InheritedRole(
  obj: InheritedRole | undefined
): Record<string, any> | undefined {
  if (obj === undefined) {
    return undefined;
  }
 ...
 */
/* eslint-disable max-len, quote-props */
export function toJson_Resource(
...
export class CfnCustomDbRole extends cdk.CfnResource {
  ...
  constructor(
    ...
    super(scope, id, {
      type: CfnCustomDbRole.CFN_RESOURCE_TYPE_NAME,
      properties: toJson_CfnCustomDbRoleProps(props)!,
    });
