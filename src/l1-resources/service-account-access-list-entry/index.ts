...
export function toJson_CfnServiceAccountAccessListEntryProps(
  obj: CfnServiceAccountAccessListEntryProps | undefined
...
export class CfnServiceAccountAccessListEntry extends cdk.CfnResource {
  ...
  constructor(
    ...
    super(scope, id, {
      type: CfnServiceAccountAccessListEntry.CFN_RESOURCE_TYPE_NAME,
      properties: toJson_CfnServiceAccountAccessListEntryProps(props)!,
    });

    this.props = props;

    this.attrCreatedAt = cdk.Token.asString(this.getAtt("CreatedAt"));
    this.attrLastUsedAddress = cdk.Token.asString(
      this.getAtt("LastUsedAddress")
    );
