...
export function toJson_CfnClusterOutageSimulationProps(obj: CfnClusterOutageSimulationProps | undefined): Record<string, any> | undefined {
...
export class CfnClusterOutageSimulation extends cdk.CfnResource {
  ...
  */
  public static readonly CFN_RESOURCE_TYPE_NAME = "MongoDB::Atlas::ClusterOutageSimulation";
   ...
   */
  constructor(scope: constructs.Construct, id: string, props: CfnClusterOutageSimulationProps) {
    super(scope, id, { type: CfnClusterOutageSimulation.CFN_RESOURCE_TYPE_NAME, properties: toJson_CfnClusterOutageSimulationProps(props)! });

    this.props = props;

    this.attrSimulationId = cdk.Token.asString(this.getAtt('SimulationId'));
    this.attrStartRequestDate = cdk.Token.asString(this.getAtt('StartRequestDate'));
