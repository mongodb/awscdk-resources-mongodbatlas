...
export function toJson_CfnBackupCompliancePolicyProps(
  obj: CfnBackupCompliancePolicyProps | undefined
  ...
  const result = {
    ...
    PolicyItemWeekly: obj.policyItemWeekly?.map((y) =>
      toJson_ScheduledPolicyItem(y)
    ),
    PolicyItemMonthly: obj.policyItemMonthly?.map((y) =>
      toJson_ScheduledPolicyItem(y)
    ),
    PolicyItemYearly: obj.policyItemYearly?.map((y) =>
      toJson_ScheduledPolicyItem(y)
    ),
  };
 ...
 */
/* eslint-disable max-len, quote-props */
export function toJson_OnDemandPolicyItem(
  obj: OnDemandPolicyItem | undefined
): Record<string, any> | undefined {
  if (obj === undefined) {
    return undefined;
  }
 ...
 */
/* eslint-disable max-len, quote-props */
export function toJson_ScheduledPolicyItem(
  obj: ScheduledPolicyItem | undefined
): Record<string, any> | undefined {
  if (obj === undefined) {
    return undefined;
  }
...
export class CfnBackupCompliancePolicy extends cdk.CfnResource {
  ...
  constructor(
    ...
    super(scope, id, {
      type: CfnBackupCompliancePolicy.CFN_RESOURCE_TYPE_NAME,
      properties: toJson_CfnBackupCompliancePolicyProps(props)!,
    });
