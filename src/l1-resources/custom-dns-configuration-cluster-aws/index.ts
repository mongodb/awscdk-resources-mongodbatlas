...
export function toJson_CfnCustomDnsConfigurationClusterAwsProps(
  obj: CfnCustomDnsConfigurationClusterAwsProps | undefined
...
export class CfnCustomDnsConfigurationClusterAws extends cdk.CfnResource {
  ...
  constructor(
    ...
    super(scope, id, {
      type: CfnCustomDnsConfigurationClusterAws.CFN_RESOURCE_TYPE_NAME,
      properties: toJson_CfnCustomDnsConfigurationClusterAwsProps(props)!,
    });
