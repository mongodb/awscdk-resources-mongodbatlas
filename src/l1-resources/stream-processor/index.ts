...
export function toJson_CfnStreamProcessorProps(
  obj: CfnStreamProcessorProps | undefined
 ...
 */
/* eslint-disable max-len, quote-props */
export function toJson_StreamsOptions(
  obj: StreamsOptions | undefined
): Record<string, any> | undefined {
  if (obj === undefined) {
    return undefined;
  }
 ...
 */
/* eslint-disable max-len, quote-props */
export function toJson_Timeouts(
 ...
 */
/* eslint-disable max-len, quote-props */
export function toJson_StreamsDlq(
  obj: StreamsDlq | undefined
): Record<string, any> | undefined {
  if (obj === undefined) {
    return undefined;
  }
...
export class CfnStreamProcessor extends cdk.CfnResource {
  ...
  constructor(
    ...
    super(scope, id, {
      ...
      properties: toJson_CfnStreamProcessorProps(props)!,
    });
