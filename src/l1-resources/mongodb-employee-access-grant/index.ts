...
export function toJson_CfnMongoDbEmployeeAccessGrantProps(
  obj: CfnMongoDbEmployeeAccessGrantProps | undefined
...
export class CfnMongoDbEmployeeAccessGrant extends cdk.CfnResource {
  ...
  constructor(
    ...
    super(scope, id, {
      type: CfnMongoDbEmployeeAccessGrant.CFN_RESOURCE_TYPE_NAME,
      properties: toJson_CfnMongoDbEmployeeAccessGrantProps(props)!,
    });
