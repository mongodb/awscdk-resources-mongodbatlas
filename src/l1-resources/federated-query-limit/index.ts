...
export function toJson_CfnFederatedQueryLimitProps(obj: CfnFederatedQueryLimitProps | undefined): Record<string, any> | undefined {
...
export class CfnFederatedQueryLimit extends cdk.CfnResource {
  ...
  */
  public static readonly CFN_RESOURCE_TYPE_NAME = "MongoDB::Atlas::FederatedQueryLimit";
  ...
  constructor(scope: constructs.Construct, id: string, props: CfnFederatedQueryLimitProps) {
    super(scope, id, { type: CfnFederatedQueryLimit.CFN_RESOURCE_TYPE_NAME, properties: toJson_CfnFederatedQueryLimitProps(props)! });
