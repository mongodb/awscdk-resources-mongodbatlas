...
export function toJson_ProcessArgs(obj: ProcessArgs | undefined): Record<string, any> | undefined {
  ...
  const result = {
    ...
    'CustomOpensslCipherConfigTls12': obj.customOpensslCipherConfigTls12?.map(y => y),
...
export function toJson_ConnectionStrings(obj: ConnectionStrings | undefined): Record<string, any> | undefined {
  ...
  const result = {
    ...
    'SRVShardOptimizedConnectionString': obj.srvShardOptimizedConnectionString?.map(y => y),
  };
  // filter undefined values
  return Object.entries(result).reduce((r, i) => (i[1] === undefined) ? r : ({ ...r, [i[0]]: i[1] }), {});
}
